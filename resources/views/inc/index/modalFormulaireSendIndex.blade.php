                      ...
                      <div class="modal-dialog" role="document">
                         <div class="modal-content1">
                            <div class="modal-body">
                                    <h5 class="modal-title text-light text-center font-weight-light mt-2 mb-5" id="exampleModalLongTitle"><i class="fas fa-pencil-alt"></i>&nbsp;Message
                                    <button type="button" class="close text-danger font-weight-light" data-dismiss="modal" aria-label="Close">
                             ...
                             <div class="col-lg-12">
                                 <p class="text-capitalize">{{ Form::textarea('message','',['class'=>'form-control','required','placeholder'=>'Votre message','rows'=>'5','text'=>'capitalize','onfocus'=>'placeholder','onblur'=>'placeholder'])}}</a>
                                     <h6 class="text-warning text-center font-weight-light"> {{Form::label('afficher','Cochez, si vous souhaitez publier votre message sur le site.')}}</h6>
                                      <p class="text-center">{{Form::checkbox('published','1',false,['class'=>'font-weight-bold','border'])}}</p>
                                  </div>  
