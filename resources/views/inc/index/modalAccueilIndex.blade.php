              ...
              <div class="modal-dialog">
                ...
                <div class="modal-content1">
                  <div class="modal-body" style="padding:40px 50px;">
                    <h4 class="text-success">Bonjour</h4>
                    <hr style="height:2px;border-width:0;color:gray;background-color:#e6b301">
                    <p class="text-light font-weight-light">Je m'appelle <strong>Maurice</strong>, j'ai 46ans, j'ai travaillé pendant 20 ans dans le transport.J'ai souhaité donné un tournant a ma carriere professionnel.<br>
                     ...
                     <hr style="height:2px;border-width:0;color:gray;background-color:#e6b301">
                    <button type="submit" class="btn btn-danger btn-default pull-center" data-dismiss="modal" id="moip"><span class="glyphicon glyphicon-remove"></span> Fermer</button>
                  </div>
                </div>
              </div>
            </div> 